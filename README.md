Aplicaciones de los embeddings satelitales de Google AlphaEarth
Foundations en el análisis geoespacial: clasificación de uso del suelo,
modelado de distribución de especies y diseño de muestreo
================

<!-- README.md se genera a partir de README.Rmd. Por favor, edita ese archivo. -->

**Presentación en el IV Congreso Internacional de Investigación,
Desarrollo e Innovación (I+D+I), UASD, 2025**
...
El acceso reciente a los embeddings satelitales de Google AlphaEarth
Foundations abre nuevas posibilidades para el análisis geoespacial sin
necesidad de entrenar modelos de aprendizaje profundo desde cero. Estos
embeddings representan información condensada de series temporales de
